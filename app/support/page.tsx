          ...
          <div className="prose prose-gray max-w-none space-y-8">
            ...
            <section>
              ...
              <div className="p-4 bg-gray-50 rounded-lg text-gray-600">
                <p><strong>Email:</strong> support@congra.app</p>
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed mt-3">
                Alternatively, you can request account deletion by emailing <strong>support@congra.app</strong>.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                We&apos;d love to hear from you. If you have suggestions for how we can improve Congra, or if something isn&apos;t working the way you&apos;d expect, let us know at <strong>support@congra.app</strong>.
              </p>
            </section>
