  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative min-h-screen flex flex-col overflow-hidden">
        ...
        <div className="absolute inset-0 z-[1] pointer-events-none bg-gradient-to-b from-black/70 via-transparent to-black/80" />
        <div className="absolute bottom-0 left-0 right-0 h-48 z-[1] pointer-events-none bg-gradient-to-b from-transparent to-[#050210]" />
          ...
          <div className="max-w-6xl mx-auto px-6 py-5 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-2.5 group">
              <Image
                ...
                width={36}
                height={36}
                className="rounded-[10px] shadow-lg shadow-black/30 group-hover:scale-105 transition-transform"
              />
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center px-6">
          <div className="max-w-3xl w-full text-center">
            <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-white/[0.06] border border-white/[0.08] backdrop-blur-md mb-10">
            ...
            <h1 className="text-5xl sm:text-7xl lg:text-8xl font-black text-white leading-[0.95] tracking-tight mb-8">
              Your city,
              <br />
              <span className="text-[#0D9488]">your crew.</span>
            </h1>

            <p className="text-lg sm:text-xl text-white/50 max-w-xl mx-auto leading-relaxed mb-12 font-normal">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a
                href="#"
                className="group inline-flex items-center gap-3 bg-white text-gray-900 pl-5 pr-7 py-3.5 rounded-2xl font-bold text-[15px] hover:bg-white/95 transition-all shadow-xl shadow-black/20"
              >
              ...
              <a
                href="#"
                className="group inline-flex items-center gap-3 bg-white/[0.08] text-white border border-white/[0.1] pl-5 pr-7 py-3.5 rounded-2xl font-bold text-[15px] hover:bg-white/[0.12] transition-all backdrop-blur-sm"
              >
            ...
            <p className="text-xs text-white/25 mt-6 font-medium tracking-wide uppercase">
      ...
      <section className="relative bg-white py-28 sm:py-36">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Feature 1 */}
            <div className="group relative bg-gray-50 rounded-3xl p-8 hover:bg-[#0D9488] transition-colors duration-300">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-12 md:gap-8">
            ...
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#0D9488] text-white text-2xl font-black mb-6">
                1
              </div>
      ...
      <section className="relative bg-gray-900 py-28 sm:py-36 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center">
          <Image
            ...
            width={72}
            height={72}
            className="rounded-[18px] mx-auto mb-8 shadow-2xl shadow-black/40"
          />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href="#"
              className="group inline-flex items-center gap-3 bg-[#0D9488] text-white pl-5 pr-7 py-3.5 rounded-2xl font-bold text-[15px] hover:bg-[#0f766e] transition-all shadow-xl shadow-[#0D9488]/20"
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="opacity-80 group-hover:opacity-100 transition-opacity">
                <path d="M18.71 19.5C17.88 20.74 17 21.95 15.66 21.97C14.32 22 13.89 21.18 12.37 21.18C10.84 21.18 10.37 21.95 9.1 22C7.79 22.05 6.8 20.68 5.96 19.47C4.25 17 2.94 12.45 4.7 9.39C5.57 7.87 7.13 6.91 8.82 6.88C10.1 6.86 11.32 7.75 12.11 7.75C12.89 7.75 14.37 6.68 15.92 6.84C16.57 6.87 18.39 7.1 19.56 8.82C19.47 8.88 17.39 10.1 17.41 12.63C17.44 15.65 20.06 16.66 20.09 16.67C20.06 16.74 19.67 18.11 18.71 19.5ZM13 3.5C13.73 2.67 14.94 2.04 15.94 2C16.07 3.17 15.6 4.35 14.9 5.19C14.21 6.04 13.07 6.7 11.95 6.61C11.8 5.46 12.36 4.26 13 3.5Z" />
              </svg>
            ...
            <a
              href="#"
              className="group inline-flex items-center gap-3 bg-white/[0.08] text-white border border-white/[0.1] pl-5 pr-7 py-3.5 rounded-2xl font-bold text-[15px] hover:bg-white/[0.12] transition-all"
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="opacity-60 group-hover:opacity-80 transition-opacity">
                <path d="M3 20.5V3.5C3 2.91 3.34 2.39 3.84 2.15L13.69 12L3.84 21.85C3.34 21.6 3 21.09 3 20.5ZM16.81 15.12L6.05 21.34L14.54 12.85L16.81 15.12ZM20.16 10.81C20.5 11.08 20.75 11.5 20.75 12C20.75 12.5 20.53 12.9 20.18 13.18L17.89 14.5L15.39 12L17.89 9.5L20.16 10.81ZM6.05 2.66L16.81 8.88L14.54 11.15L6.05 2.66Z" />
              </svg>
